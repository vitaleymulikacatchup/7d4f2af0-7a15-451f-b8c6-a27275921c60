...
export const metadata: Metadata = {
  title: "Smachno | Fine Dining Restaurant",
  description: "Experience authentic cuisine and culinary excellence at Smachno. Reserve your table today for an unforgettable dining experience.",
  keywords: "fine dining, restaurant, cuisine, reservations, culinary",
  ...
  openGraph: {
    title: "Smachno | Fine Dining Restaurant",
    description: "Experience authentic cuisine and culinary excellence at Smachno",
    type: "website",
    siteName: "Smachno",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/gallery/uploaded-1765535476930-5ojkgd9s.jpg",
      alt: "Smachno Restaurant"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Smachno | Fine Dining Restaurant",
    description: "Experience authentic cuisine and culinary excellence",
